...
print("\n=== Initial Text Generation (Untrained Model) ===")
...
print("  → (batch_size=2, seq_len=3, vocab_size=50257)\n")
...
print(f"Target probabilities (text 1): {target_probas_1}")

text_idx = 1
target_probas_2 = probas[text_idx, [0, 1, 2], targets[text_idx]]
print(f"Target probabilities (text 2): {target_probas_2}")

log_probas = torch.log(torch.cat((target_probas_1, target_probas_2)))
print(f"\nLog probabilities: {log_probas}")

avg_log_probas = torch.mean(log_probas)
print(f"Average log probability: {avg_log_probas:.4f}")

neg_avg_log_probas = avg_log_probas * -1
print(f"Negative avg log probability: {neg_avg_log_probas:.4f}")
print("-" * 50)
...
for i, (x, y) in enumerate(train_loader):
    print(f"  Batch {i+1}: input={x.shape}, target={y.shape}")
...
from .util import train_model_simple
